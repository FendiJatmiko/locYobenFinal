(function() {
    ...
    reviewDeleteModalCtrl.$inject = ['$uibModalInstance', 'locYobenData', 'reviewData'];

    function reviewDeleteModalCtrl($uibModalInstance, locYobenData, reviewData) {
        var vm = this;
        ...
        vm.doDelReview = function(locationid, reviewid) {
            locYobenData.deleteReviewById(locationid, reviewid)
